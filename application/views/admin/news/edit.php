...
<div class="matter">
        <div class="container">
            ...
            <div class="row">
                ...
                <?php if(!empty($page->id) && check_acl('news/clone_post')): ?>
                    <?php echo anchor('admin/news/clone_post/'.$page->id, '<i class="icon-share"></i>&nbsp;&nbsp;'.lang_check('Clone Post'), 'class="btn btn-primary"')?>
                <?php endif; ?>
                </div>
            </div>
          <div class="row">
