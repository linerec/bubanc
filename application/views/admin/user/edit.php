                  ...
                  <div class="padd">
                    ...
                    <?php echo form_open(NULL, array('class' => 'form-horizontal', 'role'=>'form'))?>                              
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-10">
                                    <?php echo form_password('password', set_value('password', ''), 'class="form-control" id="inputPassword" placeholder="'.lang('Password').'" '.$password_attr.' autocomplete="off"')?>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-10">
                                    <?php echo form_password('password_confirm', set_value('password_confirm', ''), 'class="form-control" id="inputPasswordConfirm" placeholder="'.lang('PasswordConfirm').'" '.$password_attr.' autocomplete="off"')?>
                                  </div>
                                </div>
