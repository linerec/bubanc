<?php
/*
Widget-title: Explore Features 4xColumns
Widget-preview-image: /assets/img/widgets_preview/top_explore_features4x_html.webp
 */
?>
<section class="explore-feature hp7 section-padding widget_edit_enabled">
    <div class="container">
        <div class="row">
            <div class="col-xl-6">
                <div class="section-heading section-heading-align-left">
                    <span><?php echo lang_check('Explore Features');?></span>
                </div>
            </div>
        </div>
        <div class="row">
