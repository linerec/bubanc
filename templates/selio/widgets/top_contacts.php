            ...
            <div class="col-xl-4 col-sm-6 col-md-6 col-lg-4">
                <div class="contact-card">
                    <div class="logo">
                        ...
                        <span class="mini-title elementor-inline-editing"><?php echo lang_check('Selio Group Headquarters');?></span>
                    </div>
                    <div class="address elementor-inline-editing"><?php echo lang_check('130 5th Avenue');?><br><?php echo lang_check('Floor 6');?><br><?php echo lang_check('New York, NY 10011');?></div>
                </div><!--card end-->
            </div>
            <div class="col-xl-4 col-sm-6 col-md-6 col-lg-4">
                <div class="contact-card featured">
                    <img src="assets/images/cities/3.webp" alt="" class="cover">
                    <h2 class="title elementor-inline-editing"><?php echo lang_check('I’m agent broker');?></h2>
                ...
                <div class="contact-card">
                    <div class="contact_info">
                        ...
                        <ul class="cont_info">
                            ...
                            ?>
                            <li><i class="la la-map-marker"></i> <span class="address elementor-inline-editing"><?php echo lang_check('212 5th Ave, New York');?></span></li>
