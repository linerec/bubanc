                ...
                <div class="header-address">
                    {not_logged}
                        <?php if (config_db_item('property_subm_disabled')==false):  ?>
                            <a href="{front_login_url}#content" class="login_popup_enabled">
                                <i class="la la-user"></i> <span><?php echo lang_check('Sign in'); ?></span>
                            </a>
                            <span><?php echo lang_check('or'); ?></span>
                            <a href="{front_login_url}#sw_register" class="">
                                <span><?php echo lang_check('Register'); ?></span>
                            </a>
                        <?php endif;?>
                    {/not_logged}
                    ...
                    {is_logged_user}
                        ...
                        <?php if (file_exists(APPPATH.'controllers/admin/savesearch.php') && false): ?>
