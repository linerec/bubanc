            ...
            <div class="col-lg-6">
                ...
                <a href='<?php _che($item['url']);?>'>
                    <div class="card cities-flexbox-1">
                        ...
                        <img src="<?php _che($item['image_url'],'assets/images/resources/pl-img1.webp');?>" alt="<?php _che($item['title']); ?>" class="img-fluid">
                        <div class="card-body">
                    ...
                    <div class="col-lg-12">
                        ...
                        <a href='<?php _che($item['url']);?>'>
                            <div class="card cities-flexbox-2">
                                <div class="overlay"></div>
                                <div class="overlay-stick"></div>
                                <img src="<?php _che($item['image_url'],'assets/images/resources/pl-img2.webp');?>" alt="<?php _che($item['title']); ?>" class="img-fluid">
                                <div class="card-body">
                                    <h4><?php _che($item['title']); ?></h4>
                                    <i class="fa fa-angle-right"></i>
                                </div>
