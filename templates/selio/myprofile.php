...
<html class="no-js" lang="en">
    ...
    <body>
                    ...
                    <div class="validation m25">
                     ...
                     <?php echo form_open(NULL, array('class' => 'form-estate', 'role'=>'form'))?>                              
                        ...
                        <div class="form-group">
                          ...
                          <div class="controls">
                            <?php echo form_password('password', set_value('password', ''), 'class="form-control" id="inputPassword" autocomplete="off" '.$password_attr.' placeholder="'.lang('Password').'"')?>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="controls">
                            <?php echo form_password('password_confirm', set_value('password_confirm', ''), 'class="form-control" id="inputPasswordConfirm" autocomplete="off" '.$password_attr.' placeholder="'.lang('PasswordConfirm').'"')?>
                          </div>
                        </div>
        ...
        <?php
        /* dinamic per listing */
        _generate_js('_generate_login_page_js_' . md5(current_url()), 'widgets/_generate_login_page_js.php', false, 0);
        ?>
    </body>
