                                                                ...
                                                                <h5>
                                                                    <?php if (!empty($item['option_36']) || !empty($item['option_37'])): ?>
                                                                        <?php if (_ch($item['option_4'], false) && stripos($item['option_4'], lang_check('Rent')) !== FAlSE): ?>
                                                                            <?php
                                                                            if (!empty($item['option_37']))
                                                                                echo ' ' . $options_prefix_37 . price_format($item['option_37'], $lang_id) . $options_suffix_37;
                                                                            if (!empty($item['option_36']))
                                                                                echo $options_prefix_36 . price_format($item['option_36'], $lang_id) . $options_suffix_36;
                                                                            ?>
                                                                        <?php else: ?>
                                                                            <?php
                                                                            if (!empty($item['option_36']))
