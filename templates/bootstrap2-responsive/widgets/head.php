                ...
                $('#contact-tabs').dcContactTabs({
                    tabs: [{
                        form: {
                            intro: {
                                type: 'textblock',
                                text: 'This is an example of a contact form with phone.'
                            },
                            name: {
                                type: 'text',
                                label: 'Your name',
                                validate: 'required,fake'
                            },
                            emailfrom: {
                                type: 'emailfrom',
                                label: 'Your email'
    ...
    <script>
        ...
        $(document).ready(function() {
                    ...
                    */
                    ...
                    <?php $dates_list = '';
                    if (isset($available_dates) && file_exists(APPPATH . 'controllers/admin/booking.php')) : ?>
                        var dates_list = [];
                                ...
                                if (mapRefresh && map) {
                                    <?php if (config_db_item('map_version') == 'open_street') : ?>
                                        ...
                                        if (data.results.length > 0) {
                                            ...
                                            map.setView(new L.LatLng(data.results_center[0], data.results_center[1]), {
                                                settings_zoom
                                            } + 1);
                                        }
                                    <?php else : ?>
                                                            ...
                                                            if (infowindow) {
                                                                ...
                                                                $(this).gmap3({
                                                                    infowindow: {
                                                                        anchor: marker,
                                                                        options: {
                                                                            disableAutoPan: mapDisableAutoPan,
                                                                            content: '<div style="width:400px;display:inline;">' + context.data + '</div>'
                                                                        }
                                                                    }
                                                                });
                                                            }
